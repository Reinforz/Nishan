...
describe('getCachedData', () => {
  ...
  it(`data doesn't exists`, async () => {
    ...
    expect(loggerMethodMock).toHaveBeenCalledWith(
      `block:block_2 doesnot exist in the cache`
    );
  });
...
it(`updateCachedData`, async () => {
  ...
  const updateCacheManuallyMock = jest
    .spyOn(NotionCache, 'updateCacheManually')
...
it(`getIterate`, async () => {
  ...
  const NotionTraverserGetMock = jest
    .spyOn(NotionTraverser, 'get')
    .mockImplementation(() => {
      return {} as any;
    });
...
it(`updateIterate`, async () => {
  ...
  const NotionTraverserUpdateMock = jest
    .spyOn(NotionTraverser, 'update')
    .mockImplementationOnce(() => {
      return {} as any;
    });
...
it(`deleteIterate`, async () => {
  ...
  const NotionTraverserDeleteMock = jest
    .spyOn(NotionTraverser, 'delete')
    .mockImplementationOnce(() => {
      return {} as any;
    });
