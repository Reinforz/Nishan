...
import { FilterTypes, IterateAndDeleteOptions, IterateAndGetOptions, IterateAndUpdateOptions, IterateOptions, Logger, NishanArg, UpdateTypes } from "../types";
...
const iterateAndGetChildren = async<T extends TData, TD, C = any[]>(args: FilterTypes<TD>, transform: ((id: string) => TD | undefined | Promise<TD | undefined>), options: IterateAndGetChildrenOptions<T, C>, cb?: ((id: string, data: TD, container: C) => any)) => {
...
const iterateAndDeleteChildren = async<T extends TData, TD, C = any[]>(args: FilterTypes<TD>, transform: ((id: string) => TD | undefined | Promise<TD | undefined>), options: IterateAndDeleteChildrenOptions<T, C>, cb?: ((id: string, data: TD, container: C) => any)) => {
...
const iterateAndUpdateChildren = async<T extends TData, CD, RD, C = any[]>(args: UpdateTypes<CD, RD>, transform: ((id: string) => CD | undefined | Promise<CD | undefined>), options: IterateAndUpdateChildrenOptions<T, C>, cb?: ((id: string, child_data: CD, updated_data: RD, container: C) => any)) => {
