...
2. Every CollectionViewPage has a [collection](../api/interfaces/_types_block_.icollectionblock.md) related to it which contains various informations including the schema of the database.
