import { Block, BoardView, CalendarView, Collection, CollectionViewPage, GalleryView, ListView, Page, RootPage, SchemaUnit, TableView, TimelineView } from "../api";
...
export interface ITRootPage { collection_view_page: CollectionViewPage[], page: RootPage[] };
