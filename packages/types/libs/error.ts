...
export interface NotionApiUserValidationPasswordNotEnteredError
  extends INotionApiError {
  message: 'Please enter your password.';
  name: 'UserValidationError';
  clientData: { type: 'password_not_entered' };
}

export interface NotionApiUserValidationIncorrectPasswordError
  extends INotionApiError {
...
export interface NotionApiUserValidationInvalidOrExpiredPasswordError
  extends INotionApiError {
...
export interface NotionApiUserValidationUserWithEmailExistsError
  extends INotionApiError {
...
export interface NotionApiUserValidationSAMLError extends INotionApiError {
  message: 'This email is not configured to use SAML SSO';
  name: 'UserValidationError';
  clientData: { type: 'email_not_configured_for_saml_sso' };
}
...
export interface NotionApiUnauthorizedLoginTryAgainError
  extends INotionApiError {
