import {
  ...
  NotionApiUserValidationSAMLError,
...
export interface INotionEndpoints {
  ...
  getSnapshotContents: INotionEndpoint<
    ...
    },
    {
      contentMap: Pick<
        RecordMap,
        'block' | 'collection' | 'collection_view' | 'space'
      >;
  ...
  >;
  getSamlRedirect: INotionEndpoint<
    {
      email: string;
    },
    Record<string, unknown> | NotionApiUserValidationSAMLError
  >;
  logoutActiveSessions: INotionEndpoint<
    Record<string, unknown>,
    Record<string, unknown>
  >;
  ...
  >;
  getDataAccessConsent: INotionEndpoint<
    Record<string, unknown>,
    { userId: string }
  >;
  disconnectDrive: INotionEndpoint<
    { googleUserId: string },
    Record<string, unknown>
  >;
  ...
  >;
  getTrelloBoards: INotionEndpoint<
    Record<string, unknown>,
    { boards: string[] }
  >;
  ...
  >;
  getSamlConfigForSpace: INotionEndpoint<
    { spaceId: string },
    Record<string, unknown>
  >;
  getAvailableCountries: INotionEndpoint<
    Record<string, unknown>,
  ...
  authWithTrello: INotionEndpoint<
    ...
    Record<string, unknown>
  >;
  authWithAsana: INotionEndpoint<
    { code: string; encryptedState: string },
    Record<string, unknown>
  >;
  disconnectAsana: INotionEndpoint<
    { code: string; encryptedState: string },
    Record<string, unknown>
  >;
  disconnectTrello: INotionEndpoint<
    Record<string, unknown>,
    Record<string, unknown>
  >;
  authWithEvernote: INotionEndpoint<
    ...
    Record<string, unknown>
  >;
  authWithGoogleForDrive: INotionEndpoint<
    { code: string },
  ...
  loadBlockSubtree: INotionEndpoint<
    ...
    {
      subtreeRecordMap: Pick<
        RecordMap,
        'block' | 'space' | 'collection_view' | 'collection'
      >;
    }
  >;
  ...
  getCsatMilestones: INotionEndpoint<
    Record<string, unknown>,
    Record<string, unknown>
  >;
