...
function DocSidebar({
  ...
  return <div className={clsx(styles.sidebar, {
    ...
    [styles.sidebarHidden]: isHidden
      ...
      {hideableSidebar && <button type="button" title="Collapse sidebar" aria-label="Collapse sidebar" className={clsx('button DocSidebar__button button--secondary button--outline', styles.collapseSidebarButton)} onClick={onCollapse}>
