export type StringViewAggregationsAggregator =
	| 'none'
	| 'count'
	| 'count_values'
	| 'unique'
...
export type NumberViewAggregationsAggregator =
...
export type DateViewAggregationsAggregator =
	| StringViewAggregationsAggregator
	| 'earliest_date'
	| 'latest_date'
	| 'date_range';
...
export type CheckboxViewAggregationsAggregator =
	| 'none'
	| 'count_all'
	| 'checked'
	| 'unchecked'
...
export type FormulaViewAggregationsAggregator =
	| NumberViewAggregationsAggregator
	| StringViewAggregationsAggregator
	| CheckboxViewAggregationsAggregator
	| DateViewAggregationsAggregator;
export type RelationViewAggregationsAggregator = StringViewAggregationsAggregator;
export type RollupViewAggregationsAggregator = 'show_unique' | TViewAggregationsAggregators;
